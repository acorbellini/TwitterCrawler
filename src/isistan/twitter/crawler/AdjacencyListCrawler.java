...
import isistan.twitterapi.GetFriendsRequest;
...
public class AdjacencyListCrawler {

	private long u;
	private ListType type;
	private UserStatus status;
	private Logger log = Logger.getLogger(AdjacencyListCrawler.class);

	public AdjacencyListCrawler(UserStatus status, long u, ListType type) {
		this.status = status;
		this.u = u;
		this.type = type;
	}
